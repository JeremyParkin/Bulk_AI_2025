...
st.header("With columns for confidence score and rationale")


# Add input for named entity
named_entity = st.text_input("Enter the named entity (e.g., brand or name):", "")
...
functions = [
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "sentiment": {
                    "type": "string",
                    "enum": ["POSITIVE", "NEUTRAL", "NEGATIVE", "IRRELEVANT"],
